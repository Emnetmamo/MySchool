...
//materails 
const absolutePath = path.join(__dirname, 'public', 'uploadedfiles', 'material');
app.use('/materials', express.static(absolutePath));

//schedule 
const absolutePath1 = path.join(__dirname, 'public', 'uploadedfiles', 'schedule');
app.use('/schedule', express.static(absolutePath1));


mongoose.connect("mongodb+srv://login:login@cluster0.1mxjghn.mongodb.net/SchoolDatabase", { useNewUrlParser: true, useUnifiedTopology: true });
