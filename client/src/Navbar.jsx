...
const Navbar = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed" style={{ height: '80px' }}>
      <Link className={`navbar-brand ${activeLink === '/' ? 'active' : ''}`} to="/" onClick={() => handleLinkClick('/')}>
        Home
      </Link>
