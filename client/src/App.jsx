...
const ConditionalNavbar = () => {
  ...
  if (path === '/login' || path === '/register' || path==="/teacher-dashboard/:teacherId"|| path === '/student-dashboard' || path ==="/parent-dashboard" ) {
...
const ConditionalFooter = () => {
  ...
  // Check if the path is for Login or Register
  if (path==="/teacher-dashboard/:teacherId"|| path === '/student-dashboard' || path ==="/parent-dashboard" ) {
    return null; // Render nothing for Login and Register pages
  }
    ...
    <Router>
      <div>
        ...
        {/* teacher routes */}
            ...
            <Route path="/teacher-dashboard/post-results/:teacherId" element={<PostResults/>} />
            <Route path="/teacher-dashboard/post-materials/:teacherId" element={<PostMaterials/>} />
            <Route path="/teacher-dashboard/post-schedules/:teacherId" element={<PostSchedules/>} />
            <Route path="/teacher-dashboard/set-appointment/:teacherId" element={<SetAppointment/>} />
            <Route path="/teacher-dashboard/send-notification/:teacherId" element={<SendNotification/>} />
            <Route path="/teacher-dashboard/send-feedback/:teacherId" element={<SendFeedback/>} />
            <Route path="/teacher-dashboard/view-feedback/:teacherId" element={<ViewFeedback/>} />
            <Route path="/teacher-dashboard/profile/:teacherId" element={<Profile/>} />
        ...
        {/* student routes */}
            ...
            <Route path="/student-dashboard/view-results/:studentId" element={<ViewResults />} />
            <Route path="/student-dashboard/view-materials/:studentId" element={<ViewMaterials />} />
            <Route path="/student-dashboard/view-schedule/:studentId" element={<ViewSchedule />} />
            <Route path="/student-dashboard/view-feedback/:studentId" element={<ViewFeedbackStudent />} />
            <Route path="/student-dashboard/send-feedback/:studentId" element={<SendFeedbackStudent />} />
            <Route path="/student-dashboard/student-profile/:studentId" element={<StudentProfile />} />
             ...
             <Route path="/parent-dashboard/check-appointments/:parentId" element={<CheckAppointments />} />
             <Route path="/parent-dashboard/check-notifications/:parentId" element={<CheckNotifications />} />
             <Route path="/parent-dashboard/send-feedback-to-teachers/:parentId" element={<SendFeedbackToTeachers />} />
             <Route path="/parent-dashboard/view-feedback/:parentId" element={<ViewFeedbackParent />} />
             <Route path="/parent-dashboard/view-profile/:parentId" element={<ViewProfile />} />
